...
namespace PantheonMapGamebar
{
    ...
    sealed partial class App : Application
    {
                ...
                if (widgetArgs.IsLaunchActivation)
                {
                    ...
                    if (widgetArgs.AppExtensionId == "MainPage")
                    {
                        mapWidget = new XboxGameBarWidget(
                            ...
                            rootFrame);
                        rootFrame.Navigate(typeof(MainPage), mapWidget);

                        Window.Current.Closed += mapWidgetWindow_Closed;
                    }                    
                    else
                    {
        ...
        private void mapWidgetWindow_Closed(object sender, CoreWindowEventArgs e)
        {
            mapWidget = null;
            Window.Current.Closed -= mapWidgetWindow_Closed;
        }
